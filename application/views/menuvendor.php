...
<div class="ui hidden divider"></div>
	<div class="ui container center aligned stackable grid">
		<div class="four wide column">
			<a href="<?php echo base_url().'tambahpaket' ?>" class="ui blue button fluid">
				<i class="ui big plus icon"></i>Tambah Paket
			</a>
		</div>
		<div class="four wide column">
			<a href="<?php echo base_url().'tampilpaket' ?>" class="ui blue button fluid">
				<i class="ui big eye icon"></i>Tampil Paket
			</a>
		</div>
		<div class="four wide column">
			<a class="ui blue button fluid" href="<?php echo base_url().'notifikasio' ?>">
